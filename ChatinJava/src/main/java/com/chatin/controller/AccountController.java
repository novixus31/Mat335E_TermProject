...
public class AccountController {
    ...
    public ResponseEntity<?> createAccount(@RequestBody Map<String, Object> body, HttpServletRequest request) {
        ...
        Integer companyOrder = body.get("companyOrder") != null ? Integer.parseInt(body.get("companyOrder").toString())
                : 0;
        ...
        return ResponseEntity.status(201).body(Map.of("success", true, "account", saved));
    }
